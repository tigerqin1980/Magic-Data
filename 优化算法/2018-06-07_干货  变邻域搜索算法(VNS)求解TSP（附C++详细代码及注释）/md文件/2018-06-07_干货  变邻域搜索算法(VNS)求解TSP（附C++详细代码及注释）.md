...
![](https://i.imgur.com/pllt4vr.png)

two_h_opt_swap
还是要说一点，随机产生两点，塞进新排列头部。其余的按顺序往后逐个塞进去。嗯，来看图片~


![](https://i.imgur.com/yV2Hz4C.png)

下面上代码啦！欲直接下载代码文件，请移步留言区哦！


![](https://i.imgur.com/WEjMOVq.jpg)
```
